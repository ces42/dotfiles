...
let s:themeOpt_transparent_background = 1
...
fun! s:register_default_theme()
  ...
  let s:themes['default'].dark = {
        ...
        \       'error_fg' : ['#af005f', '125'],
        \       'error_bg' : ['#5f0000', '52'],
        \       'matchparen_bg' : ['#15b200', '239'],
        \       'matchparen_fg' : ['#ffeb0f', '251'],
        \       'visual_fg' : ['#000000', '16'],
...
fun! s:set_color_variables()
  ...
  call s:create_color_variables('comment',    color05 , '#a0a0a0')
...
fun! s:apply_syntax_highlightings()
  ...
  exec 'hi IncSearch guibg=#fff040 guifg=#009000'
  ...
  exec 'hi Visual gui=reverse guibg=#101010'
  "exec 'hi Visual guibg=#305090'
  ...
  exec 'hi MatchParen' . s:fg_matchparen_fg . s:bg_matchparen_bg . 'gui=bold'
  "exec 'hi MatchParen' . s:fg_matchparen_fg . s:bg_matchparen_bg
  "exec 'hi MatchParen gui=bold guifg=#ffff00 guibg=#00ff00'
