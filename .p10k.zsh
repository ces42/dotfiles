# Generated by Powerlevel10k configuration wizard on 2022-07-04 at 19:19 CEST.
...
() {
  ...
  # typeset -g POWERLEVEL9K_LEFT_MIDDLE_WHITESPACE=' '
  typeset -g POWERLEVEL9K_LEFT_PROMPT_FIRST_SEGMENT_START_SYMBOL='\u2588' # █
  ...
  # not really working
  function prompt_sudo_indicator() {
    [ -z $_LAST_SUDO_TIME ] && export _LAST_SUDO_TIME=0
    if [[ $EPOCHREALTIME-$_LAST_SUDO_TIME -lt $SUDO_TIMEOUT ]] then
      p10k segment -b 'red' -f 'bright-white' -t "%B#"
    fi
  }

  # User-defined prompt segments may optionally provide an instant_prompt_* function. Its job
  # is to generate the prompt segment for display in instant prompt. See
  # https://github.com/romkatv/powerlevel10k/blob/false/README.md#instant-prompt.
  #
